...
<!-- Giao dien chi tiet so sanh 2 bai -->
<template>
  <div class="container">
    <button
      id="show-button"
...
<<<<<<< HEAD
    ...
    <div id="sidebar" :class="{ hidden: hideLeftPanel }">
      <div class="title-section">
        ...
        <h1>Chi tiết so sánh giữa 2 bài</h1>
=======
...
<<<<<<< HEAD
      ...
      <TextInformation :value="(comparison.similarity * 100).toFixed(2)" label="Tỷ lệ tương đồng %" />
=======
      <TextInformation :value="(comparison.similarity * 100).toFixed(0)" label="Match %" />
>>>>>>> 3f5ea62b8be1e5aebac14016098baa93c3c3d368
      <MatchTable
        :id1="firstId"
        :id2="secondId"
