<!--
  A view displaying the overview file of a report.
-->
...
<<<<<<< HEAD
  <div class="container" >
    <div class="column-container">
      <img src="https://itcoder.hutech.edu.vn/images/logo.png" alt="">
=======
...
>>>>>>> 3f5ea62b8be1e5aebac14016098baa93c3c3d368
      <div id="basicInfo">
        ...
        <TextInformation :has-additional-info="true" :value="overview.language" additional-info-title="Đuôi file ngôn ngữ"
          label="Ngôn ngữ">
        ...
        <TextInformation :has-additional-info="true" :value="store.getters.getSubmissionIds.size"
          additional-info-title="Bài đã nộp" label="Danh sách các bài đã nộp">
          <IDsList :ids="store.getters.getSubmissionIds" @id-sent="handleId" />
        </TextInformation>
<<<<<<< HEAD
        <TextInformation :value="overview.dateOfExecution" label="Ngày thực hiện" />
        <TextInformation :value="overview.durationOfExecution" label="Thời gian trung bình (in ms)" />
        <div id="metrics">
          <p class="section-title">Chỉ số</p>
          <div id="metrics-list">
        ...
        <div style="text-align: center;">
          <button class="button" @click="back">
            <a style=" text-decoration: none; color: black">Trở về</a>
          </button>
        </div>
    </div> 
    ...
    <div class="column-container" style="width: 40%">
      ...
      <p class="section-title">Biểu đồ thể hiện giá trị</p>
      <DistributionDiagram :distribution="distributions[selectedMetricIndex]" class="full-width" />
    </div>

    <div class="column-container" style="width: 50%">
      <!-- <p class="section-title">Bảng Xếp Hạng:</p> -->
...
=======
    ...
    <div class="column-container" style="width: 100%">
      <p class="section-title">Top Comparisons:</p> <br>
        <div v-if="missingComparisons!==0">
        <h3>Total comparisons: {{overview.totalComparisons}}<br>
           Shown comparisons: {{shownComparisons}}<br>
            Missing comparisons: {{missingComparisons}}<br>
          </h3>
      </div>
      <div id="comparisonsList">
        <ComparisonsTable
