...
<!-- Trang chu file upload len -->

<template>
  <div class="container" @dragover.prevent @drop.prevent="uploadFile">
    <img src="https://itcoder.hutech.edu.vn/images/logo.png" alt="">
    <h1>HỆ THỐNG KIỂM TRA TỰ ĐỘNG MÃ NGUỒN (IT CODER)</h1>
    <div v-if="!hasQueryFile" class="container" style="height: auto">
      <h2>Chọn 1 file mà bạn cần so sách hoặc kiểm tra sự giống nhau hoặc hiển thị tổng quan.</h2>
      <h3>(Không có tệp nào được tải lên ở bất kỳ nơi nào)</h3>
      <div class="drop-container">
        <p>Kéo thả 1 file .json hoặc file .zip vào chổ này</p>
      </div>
